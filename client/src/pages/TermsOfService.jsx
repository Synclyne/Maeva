      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <Section title="11. Third-Party Services">
            <p>
              Maeva integrates with third-party services for email delivery, hosting, and analytics. These services are governed by their own terms and privacy policies. Maeva is not responsible for the practices of these third parties.
            </p>
            <p>
